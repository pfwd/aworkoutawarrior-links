...
const FundraisingPage: React.FC = () => {
  ...
  <>
      <Helmet>
        ...
        <meta name="description" content="Join me in making a difference! Explore my current and past fundraising challenges and help support important causes through charitable donations." />
        <meta property="og:title" content="Fundraising Events - Support My Charity Challenges" />
        <meta property="og:description" content="Join me in making a difference! Explore my current and past fundraising challenges and help support important causes." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Fundraising Events - Support My Charity Challenges" />
        <meta name="twitter:description" content="Join me in making a difference! Explore my current and past fundraising challenges." />
        <link rel="canonical" href={window.location.href} />
        <meta name="keywords" content="fundraising, charity, donations, events, challenges, JustGiving" />
      </Helmet>
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {currentEvents.length > 0 && (
          <div className="mb-16">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Current Events</h2>
