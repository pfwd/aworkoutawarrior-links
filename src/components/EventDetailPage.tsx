...
const EventDetailPage: React.FC = () => {
  ...
  return (
      ...
      <Helmet>
        ...
        <meta property="og:title" content={`${event.title} - Fundraising Challenge`} />
        <meta property="og:description" content={event.description} />
        <meta property="og:image" content={event.image} />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${event.title} - Fundraising Challenge`} />
        <meta name="twitter:description" content={event.description} />
        <meta name="twitter:image" content={event.image} />
        <link rel="canonical" href={window.location.href} />
        <meta name="keywords" content={`fundraising, charity, ${event.title}, ${event.location}, JustGiving, donation`} />
      </Helmet>
